...
fisher.info <- function(par, rdata, edata, omega, par.pos){
  ...
  ## c
  sc[id.e, 'c'] <- -1/c/2 + 1/c^2/2 * r[id.e]^2 - bet.z/c * ed[id.e] * r[id.e]
  ...
  ## alp.g
  sc[id.r, name.alp.g] <- bet.z * ((rd[id.r] + Delta[id.r]) * rg[id.r, , drop = FALSE])
  sc[id.e, name.alp.g] <- sc[id.e, name.alp.g] + 1/c * (r[id.e] * eg[id.e, , drop = FALSE])
  ...
  sc[id.e, name.bet.z] <- sc[id.e, name.bet.z] + ed[id.e] * r[id.e]
